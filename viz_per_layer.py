...
EXPERIMENTS = {
    'v2': {
        ...
        'color': '#2196F3', 'marker': 'o', 'label': 'v2 (baseline, no reg)'
    },
    'env': {
        'path': 'results/kepler_cv_blocksize_entro/results_block_size_100_num_trajectories_10000_noise_scale_0.1_loss_mask_all.npz',
        'color': '#4CAF50', 'marker': 's', 'label': 'env (lambda_var=lambda_cov=0.05)'
    },
}
